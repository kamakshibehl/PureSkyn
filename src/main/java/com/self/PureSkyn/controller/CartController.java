...
public class CartController {
    ...
    public ResponseEntity<ApiResponse<List<Cart>>> getCarts(@PathVariable String userId) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(ApiResponseStatus.SUCCESS, "Cart items fetched", cart));
    }
    ...
    public ResponseEntity<ApiResponse<String>> clearCart(@PathVariable String userId) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(ApiResponseStatus.SUCCESS, "Cart cleared"));
    }
